...
public class AdminRestController {
    ...
    public ResponseEntity<com.rev.app.dto.WalletDTO> addFunds(@PathVariable Long userId,
    ...
    public ResponseEntity<com.rev.app.dto.WalletDTO> deductFunds(@PathVariable Long userId,
            @RequestBody Map<String, BigDecimal> request) {
        BigDecimal amount = request.get("amount");
    ...
    public ResponseEntity<com.rev.app.dto.LoanApplicationDTO> updateLoanStatus(@PathVariable Long id,
            @RequestBody Map<String, String> request) {
        com.rev.app.entity.LoanApplication.LoanStatus status = com.rev.app.entity.LoanApplication.LoanStatus
    ...
    public ResponseEntity<UserDTO> createUser(@RequestBody Map<String, Object> request) {
        ...
        com.rev.app.entity.User.Role role = com.rev.app.entity.User.Role
                .valueOf(((String) request.get("role")).toUpperCase());
