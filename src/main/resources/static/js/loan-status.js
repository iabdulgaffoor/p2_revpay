                            ...
                            tbody.innerHTML += `
                                <tr style="border-bottom: 1px solid var(--border-color);">
                                    ...
                                    <td style="padding: 20px 24px;">
                                        <div style="font-weight: 600; color: var(--primary-color); font-size: 0.9375rem;">USD ${loan.amount.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
                                        <div style="font-size: 0.75rem; color: var(--text-muted);">${loan.tenureMonths} Months Repayment Amortization</div>
                                    </td>
                                    <td style="padding: 20px 24px;">
                                        <div style="font-weight: 700; color: var(--primary-color); font-size: 0.9375rem;">USD ${loan.emi ? loan.emi.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) : '0.00'}<span style="font-size: 0.75rem; font-weight: 500; color: var(--text-muted);">/mo</span></div>
