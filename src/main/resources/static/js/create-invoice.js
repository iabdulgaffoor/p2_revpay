...
function addLineItem() {
    ...
    tr.innerHTML = `
        ...
        <td style="padding: 16px 20px;"><input type="number" min="1" class="item-qty" placeholder="1" style="width: 100%; padding: 10px; border: 1px solid var(--border-color); border-radius: 4px; background: var(--bg-color);" onchange="calculateTotal()" required></td>
        <td style="padding: 16px 20px;"><input type="number" min="0" step="0.01" class="item-price" placeholder="0.00" style="width: 100%; padding: 10px; border: 1px solid var(--border-color); border-radius: 4px; background: var(--bg-color);" onchange="calculateTotal()" required></td>
        <td style="padding: 16px 20px;"><input type="number" min="0" step="0.01" class="item-tax" placeholder="0.00" style="width: 100%; padding: 10px; border: 1px solid var(--border-color); border-radius: 4px; background: var(--bg-color);" onchange="calculateTotal()"></td>
...
function calculateTotal() {
    ...
    document.getElementById('grandTotalText').innerText = `INR ${grandTotal.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`;
}
